...
{
    public class MessageAction : InfoAction
    {
        public override InfoConfiguration GetDefaultInfoConfiguration(Trigger trigger)
        {
            InfoConfiguration result = new InfoConfiguration();
